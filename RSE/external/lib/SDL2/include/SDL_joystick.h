 ...
 * 32767) representing the current pTransform of the axis. It may be necessary
 * to impose certain tolerances on these values to account for jitter.
 *
 * \param joystick an SDL_Joystick structure containing joystick information
 * \param axis the axis to query; the axis indices start at index 0
 * \returns a 16-bit signed integer representing the current pTransform of the
 ...
 * \returns the current hat pTransform.
 *
 * \since This function is available since SDL 2.0.0.
 *
 ...
 * \param dx stores the difference in the x axis pTransform since the last poll
 * \param dy stores the difference in the y axis pTransform since the last poll
