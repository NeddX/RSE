...
{
    SDL_FPoint transform;        /**< Vertex actorTransform, in SDL_Renderer coordinates  */
...
/**
 * Dispose the rendering context for a window and free associated textures.
 *
