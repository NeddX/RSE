 ...
 *
 *  The variable can be set to the following values:
 *    "0"       - Report the face buttons by actorTransform, as though they were on an Xbox controller.
 *    "1"       - Report the face buttons by label instead of actorTransform
 *
 ...
 *  actorTransform when using high DPI mice.
 *
 ...
 *  transitions. In order to correctly actorTransform overlays (e.g. volume bar) and
